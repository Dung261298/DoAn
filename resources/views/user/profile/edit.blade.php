		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12">	
				<div class="breadcrumb-row">
					<h3 class="breadcrumb"><a href="/" class="home">Home</a><span>/</span><a href="{{ url('/profile') }}">{{__('profileUser.profile')}}</a><span>/</span>{{__('editprofile.edit')}}</h3>
				</div>
			</div>
		</div>
	</div>
...
<div class="container">
	...
	<div class="col-xs-12 col-sm-6 col-sm-offset-3 edit_user_info">
		<h3>{{__('editprofile.edit')}}</h3>
		<div class="line_green"></div>
		{{Form::open(['route'=>['profile.update',$users->id],'method'=>'put'])}}
			<div class="form-group">  
				<label for="">{{__('editprofile.firstname')}}:</label>                          
		    ...
		    <div class="form-group">   
				<label for="">{{__('editprofile.lastname')}}:</label>                         
			...
			<div class="form-group col-md-12">
				<div class="row">
					{{ Form::submit(trans('editprofile.save'),['class'=>'btn btn-success']) }}
